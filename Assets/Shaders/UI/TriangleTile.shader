Shader "UI/TriangleTile"
{
    ...
    SubShader
    {
        Tags
        {
            "Queue" = "Transparent" "RenderType" = "Transparent" "CanUseSpriteAtlas"="true" "IgnoreProjector"="true"
        }
        ...
        Pass
        {
            ...
            float4 frag(v2f i) : SV_Target
            {
                ...
                float2 screenPos = float2((i.screenPos.x - 0.5) * 720 * _ScreenParams.x / _ScreenParams.y,
                                                              (i.screenPos.y - 0.5) * 720);
