...
namespace ArcCreate.Gameplay.Data
{
    ...
    public abstract class ArcEvent
    {
        ...
        ///     Upon notifying manager classes of these changes with
        ///     <see cref="ChartService.UpdateEvents(System.Collections.Generic.IEnumerable{ArcEvent})" />,
        ...
        public int TimingGroup
        {
            ...
            set
            {
                if (TimingGroupChangedFrom == int.MinValue) TimingGroupChangedFrom = timingGroup;
        ...
        /// </summary>
        public bool TimingGroupChanged =>
            TimingGroupChangedFrom != int.MinValue && TimingGroupChangedFrom != TimingGroup;

        public void ResetTimingGroupChangedFrom()
        {
            TimingGroupChangedFrom = int.MinValue;
        }
