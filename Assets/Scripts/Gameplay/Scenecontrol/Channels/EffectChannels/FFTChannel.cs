...
namespace ArcCreate.Gameplay.Scenecontrol
{
    ...
    public class FFTChannel : ValueChannel
    {
        ...
        {
            //source = Services.Audio.AudioSource;
            if (freqBandMin > freqBandMax) (freqBandMin, freqBandMax) = (freqBandMax, freqBandMin);
        ...
        public override float ValueAt(int timing)
        {
            ...
            float res = 0;
            for (var i = freqBandMin; i <= freqBandMax; i++) res += SpectrumSmoothed[i] * scalar / source.volume;
