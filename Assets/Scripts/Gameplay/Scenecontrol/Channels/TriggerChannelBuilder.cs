...
namespace ArcCreate.Gameplay.Scenecontrol
{
    ...
    public class TriggerChannelBuilder
    {
        ...
        {
            return new AccumulatingTriggerChannel(triggers);
        }
        ...
        {
            return new LoopingTriggerChannel(triggers);
        }
        ...
        {
            return new StackingTriggerChannel(triggers);
        }
        ...
        {
            return new SettingTriggerChannel(triggers);
        }
    }
}