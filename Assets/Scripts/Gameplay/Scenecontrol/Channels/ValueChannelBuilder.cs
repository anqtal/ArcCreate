...
namespace ArcCreate.Gameplay.Scenecontrol
{
    ...
    public class ValueChannelBuilder
    {
        ...
        public static KeyChannel Keyframe()
        {
        ...
        [EmmyAlias("FFT")]
        public static FFTChannel FFT(int freqBandMin, int freqBandMax, float min, float max, float smoothness,
            float scalar)
        {
            return new FFTChannel(freqBandMin, freqBandMax, min, max, smoothness, scalar);
        }
        ...
        {
            return new ClampChannel(a, b, c);
        }

        [EmmyDoc("Create a conditional channel")]
        public static ConditionalChannel Condition(ValueChannel control, ValueChannel threshold, ValueChannel ifAbove,
            ValueChannel ifEqual, ValueChannel ifBelow)
        {
            return new ConditionalChannel(control, threshold, ifAbove, ifEqual, ifBelow);
        }

        [EmmyDoc("Create a constant channel")]
        public static ConstantChannel Constant(float val)
        {
            return new ConstantChannel(val);
        }
        ...
        {
            return new MinChannel(a, b);
        }

        [EmmyDoc("Create a perlin noise channel")]
        public static NoiseChannel Noise(ValueChannel frequency, ValueChannel min, ValueChannel max,
            ValueChannel offset, ValueChannel octave)
        {
            return new NoiseChannel(frequency, min, max, offset, octave);
        }

        [EmmyDoc("Create a random channel")]
        public static RandomChannel Random(int seed, ValueChannel min, ValueChannel max)
        {
            return new RandomChannel(seed, min, max);
        }
...
#pragma warning restore
            ...
            ValueChannel max,
            ValueChannel offset)
            => new(easing, period, min, max, offset);
        ...
        {
            return new SineChannel(period, min, max, offset);
        }
    }
}