...
{
    [MoonSharpUserData]
    public class NoiseChannel : ValueChannel
    {
        private ValueChannel frequency;
        private ValueChannel max;
        private ValueChannel min;
        private ValueChannel octave;
        ...
        public NoiseChannel(ValueChannel frequency, ValueChannel min, ValueChannel max, ValueChannel offset,
            ValueChannel octave)
        {
            this.octave = octave;
        ...
        {
            var octaveVal = (int)Mathf.Max(octave.ValueAt(timing), 1);
            var at = (timing + offset.ValueAt(timing)) / 1000f * frequency.ValueAt(timing);
            var noise = octaveVal == 1 ? Perlin.Noise(at) : Perlin.Fbm(at, octaveVal);
