        ...
        public static byte[] FromBase62(this string base62)
        {
            ...
            foreach (var c in base62)
            {
                ...
                if (count == base62.Length - 1)
                {
                    ...
                    if (mod == 0) throw new InvalidDataException("an extra character was found");

                    if (index >> (8 - mod) > 0) throw new InvalidDataException("invalid ending character was found");
